...
# Tear down Docker Compose stack completely, and restart. Note that we're backing up resolv.conf
# because otherwise DNS will go down once Pi-hole does and we won't be able to e.g. pull image
# updates during that downtime
